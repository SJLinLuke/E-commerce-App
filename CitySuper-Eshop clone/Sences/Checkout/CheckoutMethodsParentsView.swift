...
struct delivery: View {
    ...
    @State var currentSelectedDate: String = ""
        ...
        ScrollView {
            VStack(spacing: 0) {
                ...
                HStack {
                    Text("Delivery time :")
                        .bold()
                    Text(currentSelectedDate.convertDataFormat(fromFormat: "yyyy-MM-dd", toFormat: "yyyy/MM/dd"))
                    Spacer()
                }
                .font(.system(size: 14))
                .padding(EdgeInsets(top: 20, leading: 10, bottom: 10, trailing: 10))
                
                CalendarView(currentSelectedDate: $currentSelectedDate, startDate: "2024-06-20", endDate: "2024-07-05")
